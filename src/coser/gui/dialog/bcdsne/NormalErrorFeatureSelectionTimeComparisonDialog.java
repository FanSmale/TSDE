 ...
 * <p>
 * Author: <b>Hong Zhao, Fan Min</b> minfanphd@163.com <br>
 * Copyright: The source code and all documents are open and free. PLEASE keep
 * this header while revising the program. <br>
 * Organization: <a href=http://grc.fjzs.edu.cn/>Lab of Granular Computing</a>,
 * Zhangzhou Normal University, Fujian 363000, China.<br>
 * Progress: Done.<br>
 * Written time: November 23, 2012. <br>
 * Last modify time: November 23, 2011.
 */
public class NormalErrorFeatureSelectionTimeComparisonDialog extends Dialog
	...
	public static NormalErrorFeatureSelectionTimeComparisonDialog normalErrorFeatureSelectionTimeComparisonDialog = new NormalErrorFeatureSelectionTimeComparisonDialog();
	 ...
	 *************************** 
	 */
	private NormalErrorFeatureSelectionTimeComparisonDialog() {
		...
		helpButton
				.addActionListener(new HelpDialog(
						...
						"coser/gui/dialog/bcdsne/NormalErrorTimeComparisonDialogHelp.txt"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			// TestCostDecisionSystemNormalError currentSystem =
			...
			message = Reduction.batchComparisonNormalError(lambda, experiments);
...
}// Of class NormalErrorFeatureSelectionTimeComparisonDialog
