 ...
 * Progress: Done.<br>
 * Written time: September 11, 2012. <br>
 * Last modify time: September 22, 2012.
 */
public class NormalErrorTimeComparisonDialog extends Dialog implements
		ActionListener {
	...
	public static NormalErrorTimeComparisonDialog normalErrorTimeComparisonDialog = new NormalErrorTimeComparisonDialog();
	 ...
	 *************************** 
	 */
	private NormalErrorTimeComparisonDialog() {
		// This dialog is not module
		super(GUICommon.mainFrame, "Time comparison", true);

		lambdaField = new DoubleField("-2.5", 10);
		deltaField = new DoubleField("2.5", 10);
		...
		helpButton
				.addActionListener(new HelpDialog(
						...
						"coser/gui/dialog/tcdsne/NormalErrorTimeComparisonDialogHelp.txt"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			message = Reduction.batchComparisonNormalError(lambda, delta,
					experiments);
...
}// Of class NormalErrorTimeComparisonDialog
