 ...
 */
public class TestCostConstraintReductionDialog extends Dialog implements
		ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6873128110016531946L;

	public static TestCostConstraintReductionDialog testCostConstraintReductionDialog = new TestCostConstraintReductionDialog();
	 ...
	 *************************** 
	 */
	private TestCostConstraintReductionDialog() {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			String message = Reduction.batchTestCostConstraintReduction(
					weighting, lambdaUpperBound, lambdaLowerBound,
					lambdaStepLength, budgetFactor, experiments, showDetail);
...
}// Of class TestCostConstraintReductionDialog
