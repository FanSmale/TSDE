 ...
 * Written time: November 0, 2011. <br>
 * Last modify time: April 10, 2012.
 */
public class PositiveConstraintReductionDialog extends Dialog implements
		ActionListener {
	/**
	 * 
	 */
	...
	public static PositiveConstraintReductionDialog positiveConstraintReductionDialog = new PositiveConstraintReductionDialog();
	 ...
	 *************************** 
	 */
	private PositiveConstraintReductionDialog() {
		// This dialog is not module
		super(GUICommon.mainFrame, "Positive constraint reduction", true);
		...
		budgetFactorField = new DoubleField("0.80");
		...
		helpButton
				.addActionListener(new HelpDialog(
						...
						"src/coser/gui/dialog/tcnds/PositiveConstraintReductionDialogHelp.txt"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			String message = ReductionPosConstraint
					.batchPositiveConstraintReduction(weighting,
							lambdaUpperBound, lambdaLowerBound,
							lambdaStepLength, budgetFactor, experiments,
							showDetail);
...
}// Of class PositiveConstraintReductionDialog