 ...
 */
public class TestCostConstraintReductionCompareWithOptimalDialog extends Dialog
		implements ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1231197715018893917L;

	public static TestCostConstraintReductionCompareWithOptimalDialog testCostConstraintReductionDialog2 = new TestCostConstraintReductionCompareWithOptimalDialog();
	...
	/**
	 * Heuristic: information entropy, positive region.
	 */
	private JComboBox<String> heuristicsComboBox;
	 ...
	 *************************** 
	 */
	private TestCostConstraintReductionCompareWithOptimalDialog() {
		...
		String[] heuristicsModes = { "Positive region", "Information entropy" };
		heuristicsComboBox = new JComboBox<String>(heuristicsModes);
		...
		centerPanel.add(new Label("Heuristic mode: "));
		centerPanel.add(heuristicsComboBox);
		...
		helpButton
				.addActionListener(new HelpDialog(
						...
						"coser/gui/dialog/tcnds/TestCostConstraintReductionDialogHelp.txt"));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			boolean heuristcs = (heuristicsComboBox.getSelectedIndex() == 1);
			...
			String message = Reduction
					.batchTestCostConstraintReductionCompareWithOptimal(
							weighting, heuristcs, lambdaUpperBound,
							lambdaLowerBound, lambdaStepLength, budgetFactor,
...
}// Of class TestCostConstraintReductionDialog2
