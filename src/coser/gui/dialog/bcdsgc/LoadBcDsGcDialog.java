 ...
 */
public class LoadBcDsGcDialog extends Dialog implements ActionListener {
	...
	public static LoadBcDsGcDialog loadBcDsGcDialog = new LoadBcDsGcDialog();
	...
	private LoadBcDsGcDialog() {
		...
		arffFilenameField.setText("data/datasets/wpbc_norm.arff");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			CoserMenuBar.coserMenuBar.normalErrorFeatureSelectionTimeComparisonMenuItem
					.setEnabled(true);
			CoserMenuBar.coserMenuBar.bcDsGcOptimalFeatureSubsetMenuItem
					.setEnabled(true);
			CoserMenuBar.coserMenuBar.adaptiveBcDsGcOptimalFeatureSubsetMenuItem
					.setEnabled(true);
			CoserMenuBar.coserMenuBar.granularComputingFeatureSelectionMenuItem
					.setEnabled(true);
