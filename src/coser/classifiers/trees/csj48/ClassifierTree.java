/*
 *    Copied from ClassifierTree.java
 *
 */
...
/**
 * Class for handling a tree structure used for classification.<br>
 * 处理一个用于分类的决策树结构<br>
 * 该类生成的实例对象可以认为是决策树的一个结点
 * 
 * @author Eibe Frank (eibe@cs.waikato.ac.nz)
 * @author Zilong Xu (modified) xzl-wy163@163.com
...
public class ClassifierTree implements Drawable, Serializable,
	...
	/**
	 * The model selection method.<br>
	 * 模型选择方法
	 */
	protected ModelSelection m_toSelectModel;

	/**
	 * Local model at node.<br>
	 * 结点局部模型
	 */
	public ClassifierSplitModel m_localModel;

	/**
	 * References to sons.<br>
	 * 孩子的引用
	 */
	public ClassifierTree[] m_sons;

	/**
	 * True if node is leaf.<br>
	 * 是否为叶子结点
	 */
	protected boolean m_isLeaf;

	/**
	 * True if node is empty.<br>
	 * 是否为空结点
	 */
	protected boolean m_isEmpty;

	/**
	 * The training instances.<br>
	 * 训练集
	 */
	public Instances m_train;

	/**
	 * The pruning instances.<br>
	 * 枝数据
	 */
	protected Distribution m_test;

	/**
	 * The id for the node.<br>
	 * 结点编号
	 */
	protected int m_id;
	...
	public void buildTree(Instances data, boolean keepData) throws Exception {
		...
		// System.out.println("3: ClassifierTree: buildTree(Instances, boolean)");//
		// ////////////
	...
	public void buildClassifier(Instances data) throws Exception {
		...
		// System.out.println("buildClassifier(..)@ClassifierTree.java");//
		// //////////////////////
		// System.out.println("构建分类器@ClassifierTree.java");//
		// //////////////////////
	...
	/**
	 ********************* 
	 * Builds the tree structure with hold out set<br>
	 * 用呈现的集合构建树结构
	 * 
	 * @param train
	 *            the data for which the tree structure is to be generated.
	...
	public double classifyInstance(Instance instance) throws Exception {
		...
		// System.out.println("ClassifierTree.java: classifyInstance()");//
		// //////////////////
		// System.out.println("instance.numClass() = " +
		// instance.numClasses());// /////////////
	...
	/**
	 ********************* 
	 * Returns graph describing the tree.<br>
	 * 返回描述决策树的图
	 * 
	 * @throws Exception
	 *             if something goes wrong
	...
	public String graph() throws Exception {
		...
		// System.out.println("ClassifierTree.java:graph(): m_train = " +
		// m_train);// ////////////////
	...
	private double getProbs(int classIndex, Instance instance, double weight)
			throws Exception {
		// System.out.println("getProb(.., .., ..)@ClassifierTree.java");//
		// //////////////////
		...
		if (m_isLeaf) {
			...
			// System.out.println("记录测试了哪些属性！");// ////////////////////////////
			// System.out.println("m_localModel.m_attIndex = "
			// + m_localModel.attIndex());// ///////
			BuildAndTestTreeCostC45.attributeTested[m_localModel.attIndex()] = true;
			int treeIndex = localModel().whichSubset(instance);
			if (treeIndex == -1) {
				double[] weights = localModel().weights(instance);
				for (int i = 0; i < m_sons.length; i++) {
	...
	/**
	 ************************ 
	 * Set the leaf node status
	 ************************ 
	 */
	public void setLeaf(boolean paraStatus) {
		m_isLeaf = paraStatus;
	}// Of setLeaf
