/*
 * Copied from C45PruneableClassifierTree.java
 *
 */
...
public class C45PruneableClassifierTree extends ClassifierTree {
	...
	public void buildClassifier(Instances data) throws Exception {
		...
		// System.out
		// .println("2: buildClassifier()@C45PruneableClassifierTree.java");//
		// //////////
	...
	protected ClassifierTree getNewTree(Instances data) throws Exception {
		...
		C45PruneableClassifierTree newTree = new C45PruneableClassifierTree(
