/*
 *    Copied from NBTreeClassifierTree.java
 *
 */
...
public class NBTreeClassifierTree extends ClassifierTree {
	 ...
	 * 
	 * m_id = currLastID; if (m_sons != null) { for (int i = 0; i <
	 * m_sons.length; i++) { currLastID = m_sons[i].assignIDs(currLastID); } }
	 * return currLastID; }
	 */
	...
	public String printLeafModels() {
		...
		if (m_isLeaf) {
			...
			for (int i = 0; i < m_sons.length; i++) {
				text.append(((NBTreeClassifierTree) m_sons[i])
						.printLeafModels());
			}
		}
