...
import coser.classifiers.trees.csj48.C45PruneableClassifierTreeG;
import coser.classifiers.trees.csj48.ClassifierTree;
import coser.classifiers.trees.csj48.ModelSelection;

/**
 * <!-- globalinfo-start --> Class for generating a grafted (pruned or unpruned)
 * C4.5 decision tree. For more information, see<br/>
 * <br/>
 * Geoff Webb: Decision Tree Grafting From the All-Tests-But-One Partition. In:
 ...
 * <!-- options-end -->
 * 
 * @author Janice Boughton (jrbought@csse.monash.edu.au) (based on J48.java
 *         written by Eibe Frank)
 * @version $Revision: 5535 $
 */
public class CostJ48graft extends Classifier implements OptionHandler,
	...
	public Capabilities getCapabilities() {
		...
		try {
			result = new C45PruneableClassifierTreeG(null, !m_unpruned, m_CF,
					m_subtreeRaising, m_relabel, !m_noCleanup)
					.getCapabilities();
		} catch (Exception e) {
	...
	public void buildClassifier(Instances instances) throws Exception {
		...
		m_root = new C45PruneableClassifierTreeG(modSelection, !m_unpruned,
				m_CF, m_subtreeRaising, m_relabel, !m_noCleanup);
	 ...
	 * 
	 * -A <br>
	 * If set, Laplace smoothing is used for predicted probabilites. (note: this
	 * option only affects initial tree; grafting process always uses laplace).
	 * <p>
	 * 
	 * -E <br>
	...
	public Enumeration<Option> listOptions() {
		...
		newVector
				.addElement(new Option(
						...
						"A", 0, "-A"));
		newVector.addElement(new Option("\tRelabel when grafting.", "E", 0,
				"-E"));
	...
	public String toString() {
		...
		if (m_unpruned)
			return "CostJ48graft unpruned tree\n------------------\n"
					+ m_root.toString();
		else
			return "CostJ48graft pruned tree\n------------------\n"
					+ m_root.toString();
	}
	...
	public static void main(String[] argv) {
		runClassifier(new CostJ48graft(), argv);
	}
